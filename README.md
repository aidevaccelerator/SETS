...
- The frozen cohort lives in `dist/data/snapshot.js`. Re-freeze with `npm run snapshot` (defaults: seed 2026, 50 generations, 5 species-diverse survivors).
...
dist/
  ...
  data/snapshot.js    Frozen survivor cohort (generated by tools/make_snapshot.mjs)
  assets/             Fonts, logo, favicon
tools/fetch_data.py   Refreshes dist/data/candles.js from Binance's public API
tools/make_snapshot.mjs  Freezes the top-K genomes into dist/data/snapshot.js
